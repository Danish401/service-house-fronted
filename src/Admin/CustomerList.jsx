  ...
  return (
    <Box sx={{ padding: 4, backgroundColor: isDarkMode ? "#1f2937" : "#f5f5f5" }}>
      <Typography
        ...
        fontWeight="bold"
        gutterBottom
        sx={{ color: isDarkMode ? "#e0e0e0" : "#7d66d9", textAlign: "center" }}
      >
          ...
          : allUsers.map((user) => (
              <Grid item xs={12} sm={6} md={4} lg={3} key={user.id}>
                <Card
                  ...
                  onClick={() => navigate(`/dashboard/customers-detail/${user.id}`)}
                >
                  <CardMedia
                    component="div"
                    sx={{
                  ...
                  <CardContent sx={{ textAlign: "left", padding: 2 }}>
                    ...
                    <Typography
                      variant="h6"
                      fontWeight="bold"
                      sx={{ color: isDarkMode ? "#e0e0e0" : "#333", mt: 1 }}
                    >
                      {user.name}
                    </Typography>
                    <Typography variant="body2" sx={{ color: isDarkMode ? "#b0b0b0" : "textSecondary" }}>
                      {user.address1 || "No Address Provided"}
                    </Typography>
                  </CardContent>
                </Card>
