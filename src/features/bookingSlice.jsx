...
//       if (bookingIndex !== -1) {
//         const completedBooking = state.booked[bookingIndex];
//         state.booked.splice(bookingIndex, 1);
...
//       );
//       if (bookingIndex !== -1) {
//         const cancelledBooking = state.booked[bookingIndex];
//         state.booked.splice(bookingIndex, 1);
//         state.cancelled.push(cancelledBooking);
//       }
//     },
//     toggleDarkMode: (state) => {
...
//           booked: action.payload.filter((b) => b.status === 'Active'),
//           completed: action.payload.filter((b) => b.status === 'Completed'),
//           cancelled: action.payload.filter((b) => b.status === 'Cancelled'),
//         };
//         state.booked = categorizedData.booked;
//         state.completed = categorizedData.completed;
//         state.cancelled = categorizedData.cancelled;
//       })
...
//         state.bookingDetails[action.payload._id] = action.payload;
//       })
...
// export const { markAsCompleted, cancelBooking, toggleDarkMode } = bookingSlice.actions;
