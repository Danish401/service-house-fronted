...
//               <div key={index} className="flex flex-col items-center p-4 border border-gray-300 rounded-lg shadow-md">
//                 <img
//                   src={booking.image}
...
//                     <p className="text-sm text-gray-600">{booking.address1}</p>
//                   </div>
//                   <div className="flex items-center space-x-2">
//                     <CalendarTodayIcon className="text-indigo-400" />
//                     <p className="text-sm text-gray-600">Service on:<span className="font-semibold text-gray-800">{new Date(booking.date).toDateString()}</span></p>
//                   </div>
//                   <div className="flex items-center space-x-2">
//                     <AccessTimeIcon className="text-indigo-400" />
//                     <p className="text-sm text-gray-600">Service on:<span className="font-semibold text-gray-800">{booking.time}</span></p>
//                   </div>
//                 </div>
//                 <button
...
//                   <div className="flex items-center space-x-2">
//                     <CalendarTodayIcon className="text-indigo-400" />
//                     <p className="text-sm text-gray-600">{new Date(booking.date).toDateString()}</p>
//                   </div>
//                   <div className="flex items-center space-x-2">
//                     <AccessTimeIcon className="text-indigo-400" />
...
// import { useSelector, useDispatch } from "react-redux";
// import { fetchBookingById, markAsCompleted } from "../features/bookingSlice";
// import { Tabs, TabsContent, TabsList, TabsTrigger } from "./TabsExample";
// import CheckCircleIcon from "@mui/icons-material/CheckCircle";
// import AccessTimeIcon from "@mui/icons-material/AccessTime";
// import { FaMapMarkerAlt } from "react-icons/fa";
// import CalendarTodayIcon from "@mui/icons-material/CalendarToday";
// import PersonIcon from "@mui/icons-material/Person";
// import { useParams } from "react-router-dom"; // For dynamic ID from URL

// function MyBooking() {
//   const { bookedId } = useParams(); // Extract bookedId from the route
//   const dispatch = useDispatch();
//   const { booked, completed } = useSelector((state) => state.bookings);

//   useEffect(() => {
//     if (bookedId) {
//       dispatch(fetchBookingById(bookedId));
//     }
//   }, [dispatch, bookedId]);
...
//                 <button
//                   onClick={() =>
//                     dispatch(markAsCompleted({ id: booking._id }))
//                   }
//                   className="text-white bg-[#818cf8] hover:bg-[#9b9ef0] mt-4 p-2 rounded w-full"
//                 >
//                   Mark as Completed
...
//   const dispatch = useDispatch();
//   const { booked, completed, bookingDetails } = useSelector((state) => state.bookings);
...
//     >
//       <img
//         src={bookingDetails.employee?.image || ""}
//         alt={booking.employee?.speciality || "Service"}
//         className="object-cover w-24 h-24 mb-4 rounded-full shadow-lg"
//       />
//       <div className="space-y-2 text-center">
...
//         {/* Move the schedule button to the bottom */}
